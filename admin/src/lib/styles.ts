...
export const s = {
  ...
  sub: 'text-gray-500 dark:text-gh-muted text-sm mt-1',
  ...
  th: 'px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gh-muted uppercase tracking-wide',
  ...
  input: [
    ...
    'placeholder-gray-400 dark:placeholder-gh-muted',
  ...
  hint: 'text-xs text-gray-400 dark:text-gh-muted mt-1',
  ...
  btnSecondary: 'text-sm text-gray-600 dark:text-gh-muted px-4 py-2 rounded-lg border border-gray-300 dark:border-white/[0.12] hover:border-gray-400 dark:hover:border-white/[0.25] hover:text-gray-900 dark:hover:text-gh-text transition-colors',
  btnDanger:    'text-sm text-red-500 hover:text-red-400 font-medium transition-colors',
  ...
  modalTitle:  'font-semibold text-gray-900 dark:text-gh-text',
  ...
  alertWarn:    'bg-amber-50 dark:bg-orange-500/10 border border-amber-200 dark:border-orange-500/20 text-amber-800 dark:text-orange-400 text-sm rounded-lg px-4 py-3',

  // Text helpers
  textPrimary:   'text-gray-900 dark:text-gh-text',
  textSecondary: 'text-gray-600 dark:text-gh-muted',
  textMuted:     'text-gray-400 dark:text-gh-muted',
  textXs:        'text-xs text-gray-500 dark:text-gh-muted',

  // Badges / code tags
  codeTag:      'text-xs bg-gray-100 dark:bg-gh-over text-gray-700 dark:text-gh-text px-2 py-0.5 rounded font-mono',
  codeTagBrand: 'text-xs bg-brand-50 dark:bg-brand-500/10 text-brand-700 dark:text-brand-400 px-2 py-1 rounded font-mono',
} as const;
